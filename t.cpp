...
int main(){
   ...
   //bmat_min_test();
   //bmat_average_test();
   //bmat_eigenvalue_vector_test();
   //bmat_Jacobi_eigen_test();
   //bmat_transposition_text();
   //bmat_trace_test();
   //bmat_det_test();
   //bmat_inverse_test();
  //exception_test1();
 ...
 //smat_min_test();
 //smat_average_test();
 //smat_eigenvalue_vector_test();
 //smat_transposition_text();
 //smat_Jacobi_eigen_test();//使用雅克比算法求实对称矩阵的特征值和特征向量。
//smat_trace_test();
// smat_det_test();
 //smat_inverse_test();
}
